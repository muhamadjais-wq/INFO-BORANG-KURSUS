...
<body class="text-slate-800 antialiased relative">
    ...
    <!-- Scroll to Top -->
    <button id="scrollToTopBtn" class="fixed bottom-6 right-6 z-50 hidden bg-ikbn-gold text-ikbn-blue p-3 rounded-full shadow-xl hover:bg-yellow-400 hover:-translate-y-1 transition-all duration-300 border-2 border-ikbn-blue">
        <i data-lucide="chevron-up" class="w-6 h-6"></i>
    </button>

    <!-- SMART ASSISTANT FLOATING BUTTON -->
    <button onclick="openSmartModal()" class="fixed bottom-24 right-6 z-50 bg-ikbn-blue text-white p-4 rounded-full shadow-2xl hover:bg-blue-800 hover:scale-110 transition-all duration-300 group border-4 border-white flex items-center gap-2">
    ...
    <div id="smart-modal" class="fixed inset-0 z-[60] hidden bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all scale-95 opacity-0" id="smart-modal-content">
            <div class="bg-ikbn-blue p-6 text-white flex justify-between items-center">
                ...
                <button onclick="closeSmartModal()" class="hover:text-red-300 transition"><i data-lucide="x" class="w-6 h-6"></i></button>
            </div>
            ...
            <div class="p-6 max-h-[80vh] overflow-y-auto">
                ...
                <div id="modal-step-1">
                    ...
                    <div class="space-y-3">
                        <button onclick="smartCheck('SPM')" class="w-full text-left p-3 rounded-xl border border-slate-200 hover:border-ikbn-blue hover:bg-blue-50 transition flex items-center gap-3 group">
                        ...
                        <button onclick="smartCheck('PW2')" class="w-full text-left p-3 rounded-xl border border-slate-200 hover:border-ikbn-blue hover:bg-blue-50 transition flex items-center gap-3 group">
                        ...
                        <button onclick="smartCheck('A0')" class="w-full text-left p-3 rounded-xl border border-slate-200 hover:border-ikbn-blue hover:bg-blue-50 transition flex items-center gap-3 group">
                            <div class="bg-slate-100 p-2 rounded-full group-hover:bg-blue-200"><i data-lucide="zap" class="w-5 h-5 text-slate-600 group-hover:text-blue-700"></i></div>
                        ...
                        <button onclick="smartCheck('A1')" class="w-full text-left p-3 rounded-xl border border-slate-200 hover:border-ikbn-blue hover:bg-blue-50 transition flex items-center gap-3 group">
                            <div class="bg-slate-100 p-2 rounded-full group-hover:bg-blue-200"><i data-lucide="zap" class="w-5 h-5 text-slate-600 group-hover:text-blue-700"></i></div>
                            <div><span class="block font-bold text-slate-800">Ada A1</span><span class="text-xs text-slate-500">Talian Atas.</span></div>
                        </button>
                         <button onclick="smartCheck('A4')" class="w-full text-left p-3 rounded-xl border border-slate-200 hover:border-ikbn-blue hover:bg-blue-50 transition flex items-center gap-3 group">
                            <div class="bg-slate-100 p-2 rounded-full group-hover:bg-blue-200"><i data-lucide="zap" class="w-5 h-5 text-slate-600 group-hover:text-blue-700"></i></div>
                ...
                <!-- Result View -->
                <div id="modal-result" class="hidden text-center">
                    <div id="result-icon" class="mx-auto bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 text-green-600">
                        <i data-lucide="check-circle" class="w-8 h-8"></i>
                    </div>
                    <h4 class="text-2xl font-black text-slate-800 mb-2">Cadangan Kami</h4>
                    <p class="text-slate-600 mb-6 text-sm" id="result-text">...</p>
                    
                    <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 mb-6">
                        <span class="text-xs font-bold text-slate-400 uppercase tracking-wider">Laluan Disyorkan</span>
                        <div class="text-2xl md:text-3xl font-black text-ikbn-blue mt-1 leading-tight" id="result-course-name">KURSUS</div>
                    </div>

                    <div class="flex gap-3">
                        <button onclick="resetModal()" class="flex-1 py-3 rounded-lg border border-slate-300 text-slate-600 font-bold hover:bg-slate-50">Semula</button>
                        <a href="#kursus-ringkas" onclick="closeSmartModal()" class="flex-1 py-3 rounded-lg bg-ikbn-gold text-ikbn-blue font-bold hover:bg-yellow-400 shadow-lg">Lihat Kursus</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <header class="bg-ikbn-blue/95 backdrop-blur-md shadow-lg sticky top-0 z-40 w-full transition-all duration-300 border-b border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center space-x-3 group cursor-pointer" onclick="window.scrollTo(0,0)">
                    ...
                    <!-- TUKAR TEXT-WHITE KEPADA TEXT-BLUE-100 -->
                    <div class="text-blue-100 leading-tight">
                ...
                <nav class="hidden md:flex space-x-1">
                    <a href="#misi-visi" class="px-3 py-2 text-sm font-medium text-blue-100 hover:text-ikbn-gold hover:bg-white/10 rounded-md transition">Visi & Misi</a>
                    <a href="#kursus-ringkas" class="px-3 py-2 text-sm font-medium text-blue-100 hover:text-ikbn-gold hover:bg-white/10 rounded-md transition">Senarai Kursus</a>
                    <a href="#permohonan" class="px-3 py-2 text-sm font-medium text-blue-100 hover:text-ikbn-gold hover:bg-white/10 rounded-md transition">Permohonan</a>
                    <a href="#hubungi" class="px-3 py-2 text-sm font-medium text-bg-ikbn-gold text-ikbn-blue bg-ikbn-gold rounded-md shadow-md hover:bg-yellow-300 transition flex items-center animate-pulse hover:animate-none">
                        <i data-lucide="phone" class="w-4 h-4 mr-1.5"></i> Hubungi
                    </a>
                </nav>
                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-btn" class="text-blue-100 hover:text-ikbn-gold p-2 focus:outline-none">
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-blue-900 border-t border-blue-800 absolute w-full shadow-xl">
            <div class="px-4 pt-2 pb-6 space-y-1">
                <a href="#misi-visi" class="mobile-link block px-3 py-3 text-base font-medium text-blue-100 hover:bg-blue-800 rounded-md">Visi & Misi</a>
                <a href="#kursus-ringkas" class="mobile-link block px-3 py-3 text-base font-medium text-blue-100 hover:bg-blue-800 rounded-md">Senarai Kursus</a>
                <a href="#permohonan" class="mobile-link block px-3 py-3 text-base font-medium text-blue-100 hover:bg-blue-800 rounded-md">Cara Memohon</a>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        <!-- Hero Section -->
        <section class="relative bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-ikbn-gold fade-in-up min-h-[500px] flex items-center" style="animation-delay: 0.1s;">
            ...
            <div class="p-8 md:p-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 w-full">
                <div class="flex-1 glass-panel p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="p-2 bg-blue-50 rounded-lg"><i data-lucide="zap" class="w-8 h-8 text-ikbn-blue"></i></div>
                        <span class="text-sm font-bold tracking-widest text-ikbn-blue uppercase bg-blue-100 px-3 py-1 rounded-full">Program ECoS</span>
                    </div>
                    <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 leading-tight">
                        Program Kompetensi <span class="text-ikbn-blue">Elektrik</span>
                    </h2>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#kursus-ringkas" class="bg-ikbn-blue text-white px-6 py-3 rounded-lg font-bold shadow-lg hover:bg-blue-800 transition transform hover:-translate-y-1 flex items-center flow-line overflow-hidden">
                            <span class="relative z-10 flex items-center">Lihat Kursus <i data-lucide="arrow-down" class="ml-2 w-4 h-4"></i></span>
                        </a>
                        <button onclick="openSmartModal()" class="bg-white text-ikbn-blue border-2 border-ikbn-blue px-6 py-3 rounded-lg font-bold hover:bg-blue-50 transition transform hover:-translate-y-1 flex items-center">
                            <i data-lucide="bot" class="w-4 h-4 mr-2"></i> Bantuan Pintar
                        </button>
                    </div>
                    <div class="mt-4 flex items-center gap-2">
                        <span class="bg-green-100 text-green-800 text-xs font-bold px-2 py-1 rounded border border-green-200">HRDF Claimable</span>
                        <span class="bg-blue-100 text-blue-800 text-xs font-bold px-2 py-1 rounded border border-blue-200">ECoS Accredited</span>
                    </div>
                </div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-4 gap-6 fade-in-up" style="animation-delay: 0.2s;">
            <div class="bg-gradient-to-br from-ikbn-blue to-blue-800 p-6 rounded-2xl shadow-lg text-white flex flex-col justify-between relative overflow-hidden group">
                <div class="absolute right-0 top-0 opacity-10 transform translate-x-4 -translate-y-4"><i data-lucide="bar-chart-2" class="w-32 h-32"></i></div>
                <div>
                    <div class="flex items-center space-x-2 text-blue-200 mb-2"><i data-lucide="users" class="w-5 h-5"></i><span class="text-xs font-bold uppercase tracking-wider">Pelawat</span></div>
                    <div class="text-4xl md:text-5xl font-black text-ikbn-gold tracking-tighter" id="visitor-count">...</div>
                </div>
            </div>
            <div class="md:col-span-3 bg-white p-6 rounded-2xl shadow-lg border border-slate-100">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <a href="https://forms.gle/uvJa9qgGkYsAcFVr7" target="_blank" class="flex flex-col items-center justify-center p-4 rounded-xl bg-slate-50 hover:bg-blue-50 transition border border-slate-200"><i data-lucide="message-square" class="w-8 h-8 text-blue-600 mb-2"></i><span class="text-xs font-bold text-slate-600">MAKLUM BALAS</span></a>
                    <a href="https://www.facebook.com/people/Jabatan-Elektrik-Ikbn-Kinarut/100073449556010/" target="_blank" class="flex flex-col items-center justify-center p-4 rounded-xl bg-slate-50 hover:bg-blue-50 transition border border-slate-200"><i data-lucide="facebook" class="w-8 h-8 text-blue-800 mb-2"></i><span class="text-xs font-bold text-slate-600">FACEBOOK</span></a>
                    <a href="https://www.tiktok.com/@jabatan.elektrik" target="_blank" class="flex flex-col items-center justify-center p-4 rounded-xl bg-slate-50 hover:bg-slate-100 transition border border-slate-200"><span class="w-8 h-8 flex items-center justify-center mb-2"><svg viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-black"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg></span><span class="text-xs font-bold text-slate-600">TIKTOK</span></a>
                    <a href="https://maps.app.goo.gl/UbdhERujykyLpUrJ7" target="_blank" class="flex flex-col items-center justify-center p-4 rounded-xl bg-slate-50 hover:bg-red-50 transition border border-slate-200"><i data-lucide="map-pin" class="w-8 h-8 text-red-600 mb-2"></i><span class="text-xs font-bold text-slate-600">LOKASI</span></a>
                </div>
            </div>
        </section>
        ...
        <section id="kursus-ringkas" class="space-y-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
                ...
                <article class="flex flex-col bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition duration-300">
                    ...
                    <!-- UPDATE BUTTON PW2 -->
                    <div class="p-4 bg-slate-50 border-t"><a href="#hubungi" class="block w-full text-center bg-ikbn-gold text-ikbn-blue font-bold py-3 rounded-lg hover:bg-yellow-400 shadow-md">Hubungi Urusetia</a></div>
                </article>
                <!-- PW4 -->
                <article class="flex flex-col bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition duration-300">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <article class="flex flex-col bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition duration-300 h-full">
                    ...
                    <div class="p-4 bg-slate-50 border-t"><a href="https://forms.gle/ZeXBrrAGaYtxr2u67" target="_blank" class="block w-full text-center bg-ikbn-gold text-ikbn-blue font-bold py-3 rounded-lg hover:bg-yellow-400 shadow-md">Mohon A0</a></div>
                </article>
                ...
                <article class="flex flex-col bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition duration-300 h-full">
                    ...
                    <div class="p-4 bg-slate-50 border-t"><a href="https://forms.gle/TJpNuYjMt9GUGNHG8" target="_blank" class="block w-full text-center bg-ikbn-gold text-ikbn-blue font-bold py-3 rounded-lg hover:bg-yellow-400 shadow-md">Mohon A1</a></div>
                </article>
                ...
                <article class="flex flex-col bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition duration-300 h-full">
                    ...
                    <div class="p-4 bg-slate-50 border-t"><a href="https://forms.gle/28Fy1RD8dZukcUrP6" target="_blank" class="block w-full text-center bg-ikbn-gold text-ikbn-blue font-bold py-3 rounded-lg hover:bg-yellow-400 shadow-md">Mohon A4</a></div>
                </article>
                ...
                <article class="flex flex-col bg-slate-800 rounded-2xl shadow-xl border border-slate-700 hover:shadow-2xl transition duration-300 h-full relative lg:col-span-3">
                    ...
                    <div class="p-6 grid md:grid-cols-2 gap-6 text-slate-200">
                        ...
                        <div>
                            ...
                            <a href="https://forms.gle/zaMeYgkWMUbQ1HP18" target="_blank" class="mt-4 block w-full text-center bg-red-600 hover:bg-red-700 text-white font-bold py-2 rounded-lg transition shadow-md">Mohon B0</a>
                        </div>
                    </div>
                </article>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-4 rounded-xl shadow border border-slate-200 hover:shadow-md transition flex flex-col h-full">
                    ...
                    <a href="https://forms.gle/wtq2pc6yYB7UjzM59" target="_blank" class="mt-3 block w-full text-center bg-slate-700 hover:bg-slate-800 text-white text-xs font-bold py-2 rounded transition">Mohon TAVR</a>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow border border-slate-200 hover:shadow-md transition flex flex-col h-full">
                    ...
                    <a href="https://forms.gle/acb7zLHTXScLzYoJ7" target="_blank" class="mt-3 block w-full text-center bg-slate-700 hover:bg-slate-800 text-white text-xs font-bold py-2 rounded transition">Mohon JKVR</a>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow border border-slate-200 hover:shadow-md transition flex flex-col h-full">
                    ...
                    <a href="https://forms.gle/3cAfRxsn9AQe63Mv5" target="_blank" class="mt-3 block w-full text-center bg-slate-700 hover:bg-slate-800 text-white text-xs font-bold py-2 rounded transition">Mohon MKP</a>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow border border-slate-200 hover:shadow-md transition flex flex-col h-full">
                    ...
                    <a href="#hubungi" class="mt-3 block w-full text-center border border-slate-300 text-slate-600 text-xs font-bold py-2 rounded hover:bg-slate-100 transition">Hubungi Urusetia</a>
                </div>
            </div>
        </section>
        ...
        <section id="permohonan" class="bg-ikbn-blue rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                <div class="flex items-center mb-8 border-b border-blue-500 pb-4">
                    <div class="bg-ikbn-gold p-3 rounded-lg text-ikbn-blue mr-4 shadow-[0_0_15px_rgba(255,204,0,0.5)]"><i data-lucide="download-cloud" class="w-8 h-8"></i></div>
                    <div><h2 class="text-2xl md:text-3xl font-bold">Dokumen & Pendaftaran</h2><p class="text-blue-200">Pastikan lengkap sebelum menghantar.</p></div>
                </div>
                <div class="grid md:grid-cols-2 gap-12">
                    <div>
                        <h3 class="text-xl font-bold text-ikbn-gold mb-4">Langkah 1: Muat Turun</h3>
                        <p class="text-blue-100 mb-6 text-sm leading-relaxed">Sila muat turun borang rasmi dan senarai semak. Lengkapkan semua butiran sebelum mengisi borang online.</p>
                        <a href="https://drive.google.com/file/d/1715CZNVigrQBpf5nZ0Zne6Rne8xC8tUF/view?usp=sharing" target="_blank" class="inline-flex items-center bg-white text-ikbn-blue font-bold py-4 px-6 rounded-xl shadow-lg hover:bg-blue-50 hover:scale-105 transition duration-300">
                            <i data-lucide="file-text" class="w-5 h-5 mr-3"></i> MUAT TURUN BORANG
                        </a>
                    </div>
                    <div class="bg-blue-900/50 p-6 rounded-xl border border-blue-700 backdrop-blur-sm">
                        <h3 class="text-lg font-bold text-white mb-4 flex items-center"><i data-lucide="list-checks" class="w-5 h-5 mr-2"></i> Senarai Semak Wajib</h3>
                        <ul class="space-y-2 text-sm text-blue-100">
                            <li class="flex items-start"><i data-lucide="check" class="w-4 h-4 mr-2 text-green-400 mt-0.5"></i> Borang Lengkap & Kad Pengenalan</li>
                            <li class="flex items-start"><i data-lucide="check" class="w-4 h-4 mr-2 text-green-400 mt-0.5"></i> Bukti Daftar ECoS (Calon & Majikan)</li>
                            <li class="flex items-start"><i data-lucide="check" class="w-4 h-4 mr-2 text-green-400 mt-0.5"></i> Surat Majikan & KWSP</li>
                            <li class="flex items-start"><i data-lucide="check" class="w-4 h-4 mr-2 text-green-400 mt-0.5"></i> Sijil Kompeten Terdahulu (Jika ada)</li>
                            <li class="flex items-start"><i data-lucide="check" class="w-4 h-4 mr-2 text-green-400 mt-0.5"></i> Buku Log Disahkan</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Animated Progression Flowchart (UPDATED) -->
        <section id="progression" class="bg-white rounded-2xl shadow-lg p-8 relative overflow-hidden">
            <div class="text-center mb-10 relative z-10">
                ...
                <p class="text-slate-500">Mendaki tangga kompetensi dari asas ke pakar.</p>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 overflow-x-auto pb-4 relative z-10">
                ...
                <div class="flex flex-col items-center group cursor-pointer node-animate delay-0" onclick="smartCheck('SPM'); openSmartModal();">
                    <div class="w-24 h-24 rounded-full border-4 border-slate-300 flex items-center justify-center bg-slate-50 group-hover:bg-slate-200 transition duration-300 z-20 relative">
                ...
                <div class="flex flex-col items-center group cursor-pointer node-animate delay-1" onclick="smartCheck('PW2'); openSmartModal();">
                    <div class="w-24 h-24 rounded-full border-4 border-slate-600 flex items-center justify-center bg-slate-50 group-hover:bg-slate-600 transition duration-300 z-20 relative">
                ...
                <div class="flex flex-col items-center group cursor-pointer node-animate delay-2" onclick="smartCheck('A0'); openSmartModal();">
                    <div class="w-24 h-24 rounded-full border-4 border-ikbn-blue flex items-center justify-center bg-blue-50 group-hover:bg-ikbn-blue transition duration-300 z-20 relative">
                ...
                <div class="flex flex-col items-center group cursor-pointer node-animate delay-3" onclick="smartCheck('A1'); openSmartModal();">
                    <div class="w-24 h-24 rounded-full border-4 border-ikbn-gold flex items-center justify-center bg-yellow-50 group-hover:bg-ikbn-gold transition duration-300 z-20 relative">
                ...
                <div class="flex flex-col items-center group cursor-pointer node-animate delay-4" onclick="smartCheck('A4'); openSmartModal();">
                    <div class="w-24 h-24 rounded-full border-4 border-slate-800 flex items-center justify-center bg-slate-100 group-hover:bg-slate-800 transition duration-300 z-20 relative">
                ...
                <div class="md:hidden flex items-center relative h-16 w-2 my-2">
                 ...
                 <!-- NODE 6: B0 -->
                 <div class="flex flex-col items-center group node-animate delay-5">
                    <div class="w-24 h-24 rounded-full border-4 border-red-600 flex items-center justify-center bg-red-50 group-hover:bg-red-600 transition duration-300 shadow-xl z-20 relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-center md:text-left">
                ...
                <div class="flex flex-col items-center md:items-start">
                    <a href="https://maps.app.goo.gl/UbdhERujykyLpUrJ7" target="_blank" class="flex items-center justify-center md:justify-start space-x-2 text-slate-300 hover:text-white transition bg-slate-800 px-4 py-2 rounded-lg mb-4">
    ...
    <script>
        ...
        class Particle {
            ...
            draw() {
                ...
                ctx.fillStyle = 'rgba(0, 77, 153, 0.3)';
                ctx.fill();
            }
        }
        ...
        function animateCanvas() {
            ...
            for (let i = 0; i < particles.length; i++) {
                ...
                for (let j = i; j < particles.length; j++) {
                    ...
                    if (dist < 100) {
                        ctx.beginPath();
                        ctx.strokeStyle = `rgba(0, 77, 153, ${0.15 - dist/1000})`;
                        ctx.lineWidth = 0.5;
        ...
        function smartCheck(status) {
            ...
            // Logik Lanjutan Berdasarkan Data Baru
            if (status === 'SPM') {
                resultText.innerText = "Bermula dari awal? Anda ada dua pilihan: Ambil PW2 (Pendawai Fasa Tunggal) jika umur 18+, atau A0 (Penjaga Jentera) jika umur 20+ dan cukup pengalaman 3 tahun.";
                resultCourse.innerText = "PW2 ATAU A0";
            } else if (status === 'PW2') {
                resultText.innerText = "Anda sudah kompeten PW2. Langkah seterusnya adalah PW4 (Fasa Tiga). Pastikan ada 1 tahun pengalaman PW1/PW2.";
                resultCourse.innerText = "KURSUS PW4";
            } else if (status === 'A0') {
                resultText.innerText = "Pemegang A0 boleh ke A1 (jika ada 1 thn pengalaman Overhead) atau terus ke A4 (melalui Modul JKVR).";
                resultCourse.innerText = "A1 ATAU MODUL JKVR";
            } else if (status === 'A1') {
                resultText.innerText = "Pemegang A1 selalunya kurang pengalaman Janakuasa. Ambil Modul JKVR untuk melayakkan anda ke A4.";
                resultCourse.innerText = "MODUL JKVR -> A4";
            } else if (status === 'A4') {
                resultText.innerText = "Tahniah! Anda berada di puncak Voltan Rendah. Cabaran seterusnya adalah Voltan Tinggi.";
                resultCourse.innerText = "KURSUS B0 (11kV)";
            }
        }
    </script>
</body>
